...
// at some point we will slide this into CGo for testing
#include <stdint.h>
#include <stddef.h>
#define xadUINT8 uint8_t
#define xadINT8 int8_t
#define xadUINT16 uint16_t
#define xadINT16 int16_t
#define xadUINT32 uint32_t
#define xadINT32 int32_t
#define xadERROR int
#define XADM
typedef char *xadSTRPTR;
...
struct xadInOut {
  ...
  long xio_CRC32;
  long xio_CRC16;
}; // we cheat by using globals...

struct xadInOut bigio;

#define XADERR_NOMEMORY -'m'
#define XADERR_ILLEGALDATA -'d'
#define XADERR_CHECKSUM -'c'
...
#define XADMEMF_CLEAR 0
#define XADMEMF_PUBLIC 0
...
//     // case SITlzc: err = xadIO_Compress(io, 14|UCOMPBLOCK_MASK); break; // implemented elsewhere, well known
