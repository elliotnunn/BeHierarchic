...
// func  SIT13_Func1(SIT13Data *s, SIT13Buffer *buf, uint32 info, uint16 bits, uint16 num) void {
// var i, j uint32
...
// func  SIT13_SortTree(SIT13Data *s, SIT13Buffer *buf, SIT13Buffer *buf2) void {
// var td uint16;
// var tb int8;
...
// func  SIT13_Func2(SIT13Data *s, SIT13Buffer *buf, uint16 bits, SIT13Buffer *buf2) void {
// var i int32, j, k, l, m, n;
...
// func  SIT13_CreateStaticTree(SIT13Data *s, SIT13Buffer *buf, uint16 bits, uint8 *bitsbuf) void {
// var i uint32;
...
// func  SIT13InitInfo(SIT13Data *s, uint8 id) void {
// var i int32;
// var k uint8, l = 0, *a, *b;
...
// func  SIT13_Extract(SIT13Data *s, xadInOut *io) void {
...
// func  SIT13_CreateTree(SIT13Data *s, xadInOut *io, SIT13Buffer *buf, uint16 num) void {
//   var b *SIT13Buffer
// var i uint32;
// var data uint16;
// var bi int8 = 0;
...
// func  SIT_13(xadInOut *io) int32 {
// var i uint32, j;
//   var xadMasterBase *xadMasterBase = io.xio_xadMasterBase;
//   var s *SIT13Data

//   if((s = xadAllocVec(XADM sizeof(SIT13Data), XADMEMF_CLEAR)))
//   {
//     s.MaxBits = 1;
//     for(i = 0; i < 37; ++i)
...
//       if(j&8)
//         xadCopyMem(XADM (xadPTR) s.Buffer3, (xadPTR) s.Buffer3b, 0x1000*sizeof(SIT13Buffer));
//       else
